...
d_neighborhood <- neighborhood_shp %>% 
  ...
  mutate(n_acvs_per_1000hh = n_acvs/num_hh*1000,
         acvs_fractional_screen_in = n_acvs_screened_in/n_acvs,
         n_acvs_white_per_1000hh = n_white_acvs/num_hh*1000,
         acvs_white_fractional_screen_in = n_white_acvs_screened_in/n_white_acvs,
         n_acvs_black_per_1000hh = n_black_acvs/num_hh*1000,
...
d_neighborhood %>%
  ...
  select(Neighborhood = neighborhood, 
        ...
        `Number ACVs per 1000 Households` = n_acvs_per_1000hh,
        `Fraction of ACVs Screened In` = acvs_fractional_screen_in,
        `Number of White ACVs` = n_white_acvs,
        `White ACVs per 1000 Households` = n_acvs_white_per_1000hh,
        ...
        `Black/African American ACVs per 1000 Households` = n_acvs_black_per_1000hh,
...
### ACVs per 1000 Households

The two maps below show the ACV Rate (number of acvs per 1000 households) by neighborhood and by race.  

```{r, fig.width = 10, fig.height=8}
tm_basemap("CartoDB.Positron") +
  tm_shape(d_neighborhood) +
  tm_polygons(col = c('n_acvs_white_per_1000hh',
                      'n_acvs_black_per_1000hh'),
              title = c('White',
                        'Black/African American'),
              popup.vars = c('White ACVs per 1000 Households' = 'n_acvs_white_per_1000hh',
                             'Black/African American ACVs per 1000 Households' = 'n_acvs_black_per_1000hh'),
              alpha = 0.8,
              palette = 'Blues') +
  tm_scale_bar() +
...
The two maps below show the Fraction of ACVs Screened In (number of intakes that were screened in / number of intakes) by neighborhood and by race. 
