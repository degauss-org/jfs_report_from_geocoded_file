...
```{r}
d <- params$d
# d <- read_csv('test/aft_example_data_long_geocoded.csv',
...
`r nrow(d_missing_alleg_add)` intakes are missing allegation address. The most recently entered child address will be used.
